...
export default defineConfig({
  testDir: './tests/e2e',
  fullyParallel: true,
  // A .only left in a committed test silently skips the rest of the suite.
  ...
  use: {
    ...
    // Playwright version would download. Point at it instead of re-downloading
    // a second browser into the image.
